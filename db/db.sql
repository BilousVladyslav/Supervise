...
--
-- Name: workplaces_area; Type: TABLE; Schema: public; Owner: user_name
--

CREATE TABLE public.workplaces_area (
    id integer NOT NULL,
    title character varying(150) NOT NULL,
    description text NOT NULL,
    workers_count integer NOT NULL,
    working_now integer NOT NULL,
    location_id integer NOT NULL
);


ALTER TABLE public.workplaces_area OWNER TO user_name;

--
-- Name: workplaces_area_id_seq; Type: SEQUENCE; Schema: public; Owner: user_name
--

CREATE SEQUENCE public.workplaces_area_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.workplaces_area_id_seq OWNER TO user_name;

--
-- Name: workplaces_area_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user_name
--

ALTER SEQUENCE public.workplaces_area_id_seq OWNED BY public.workplaces_area.id;


--
-- Name: workplaces_workobject; Type: TABLE; Schema: public; Owner: user_name
--

CREATE TABLE public.workplaces_workobject (
    id integer NOT NULL,
    name character varying(150) NOT NULL,
...
ALTER TABLE public.workplaces_workobject OWNER TO user_name;

--
-- Name: workplaces_workobject_id_seq; Type: SEQUENCE; Schema: public; Owner: user_name
--

CREATE SEQUENCE public.workplaces_workobject_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.workplaces_workobject_id_seq OWNER TO user_name;

--
-- Name: workplaces_workobject_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user_name
--

ALTER SEQUENCE public.workplaces_workobject_id_seq OWNED BY public.workplaces_workobject.id;
...
--
-- Name: workplaces_area id; Type: DEFAULT; Schema: public; Owner: user_name
--

ALTER TABLE ONLY public.workplaces_area ALTER COLUMN id SET DEFAULT nextval('public.workplaces_area_id_seq'::regclass);


--
-- Name: workplaces_workobject id; Type: DEFAULT; Schema: public; Owner: user_name
--

ALTER TABLE ONLY public.workplaces_workobject ALTER COLUMN id SET DEFAULT nextval('public.workplaces_workobject_id_seq'::regclass);
...
29	Can add work object	8	add_workobject
30	Can change work object	8	change_workobject
31	Can delete work object	8	delete_workobject
32	Can view work object	8	view_workobject
...
1	pbkdf2_sha256$216000$uTi1bEqlHV2C$8GXAdnybyeB/77EQvIVkmBZ2cSVC3KbqDz0L0UkFx3U=	2020-08-16 23:21:56.720786+03	t	admin	Just	Admin	admin@admin.com	t	t	2020-08-15 21:43:48.700028+03
\.
...
a1100f787eb64e992541271f8856a63a7eef1419	2020-08-15 23:52:45.910195+03	1
\.
...
1	2020-08-16 23:23:05.00679+03	10	WorkObject object (10)	3		8	1
2	2020-08-16 23:23:05.019786+03	9	WorkObject object (9)	3		8	1
3	2020-08-16 23:23:05.022786+03	8	WorkObject object (8)	3		8	1
4	2020-08-16 23:23:05.024787+03	7	WorkObject object (7)	3		8	1
5	2020-08-16 23:23:05.026789+03	6	WorkObject object (6)	3		8	1
6	2020-08-16 23:23:05.02779+03	5	WorkObject object (5)	3		8	1
7	2020-08-16 23:23:05.030789+03	4	WorkObject object (4)	3		8	1
8	2020-08-17 14:48:49.704635+03	1	Area object (1)	1	[{"added": {}}]	9	1
\.
...
1	contenttypes	0001_initial	2020-08-15 21:35:26.957101+03
2	auth	0001_initial	2020-08-15 21:35:27.178092+03
3	admin	0001_initial	2020-08-15 21:35:27.584095+03
4	admin	0002_logentry_remove_auto_add	2020-08-15 21:35:27.63909+03
5	admin	0003_logentry_add_action_flag_choices	2020-08-15 21:35:27.654093+03
6	contenttypes	0002_remove_content_type_name	2020-08-15 21:35:27.686093+03
7	auth	0002_alter_permission_name_max_length	2020-08-15 21:35:27.700095+03
8	auth	0003_alter_user_email_max_length	2020-08-15 21:35:27.717091+03
9	auth	0004_alter_user_username_opts	2020-08-15 21:35:27.731091+03
10	auth	0005_alter_user_last_login_null	2020-08-15 21:35:27.746091+03
11	auth	0006_require_contenttypes_0002	2020-08-15 21:35:27.751095+03
12	auth	0007_alter_validators_add_error_messages	2020-08-15 21:35:27.76909+03
13	auth	0008_alter_user_username_max_length	2020-08-15 21:35:27.816095+03
14	auth	0009_alter_user_last_name_max_length	2020-08-15 21:35:27.833093+03
15	auth	0010_alter_group_name_max_length	2020-08-15 21:35:27.85209+03
16	auth	0011_update_proxy_permissions	2020-08-15 21:35:27.868092+03
17	auth	0012_alter_user_first_name_max_length	2020-08-15 21:35:27.883095+03
18	authtoken	0001_initial	2020-08-15 21:35:27.941102+03
19	authtoken	0002_auto_20160226_1747	2020-08-15 21:35:28.03209+03
20	sessions	0001_initial	2020-08-15 21:35:28.08909+03
21	workplaces	0001_initial	2020-08-15 21:35:28.238102+03
\.
...
0xh3p2i6bbbrphhyxp4mqu0fpykkyuwq	.eJxVjMEOwiAQRP-FsyELUigevfsNZIFdqRpISnsy_rtt0oNe5jDvzbxFwHUpYe00hymLi1Di9NtFTE-qO8gPrPcmU6vLPEW5K_KgXd5aptf1cP8OCvayrT1DJk3esBq0sS6DBoealWc3GkyRjXNmUJTZW4UGLI12C4ZoAc5WfL7XMDdI:1k7PAC:cEb_FKSjM8UIR0xHwB4aR3u-4QGksHioXs0aaXnm0gY	2020-08-30 23:21:56.724787+03
\.


--
-- Data for Name: workplaces_area; Type: TABLE DATA; Schema: public; Owner: user_name
--

COPY public.workplaces_area (id, title, description, workers_count, working_now, location_id) FROM stdin;
1	First testing area	This area is intended to show, how system works.	7	7	1
2	fdsf	fsdfsd	4	0	1
3	Normal title	Normal description	5	0	1
\.


--
-- Data for Name: workplaces_workobject; Type: TABLE DATA; Schema: public; Owner: user_name
--

COPY public.workplaces_workobject (id, name, address, supervisor_id) FROM stdin;
1	First Testing Work Object	Kharkiv, st. Naukova	1
\.
...
--
-- Name: workplaces_area_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user_name
--

SELECT pg_catalog.setval('public.workplaces_area_id_seq', 3, true);


--
-- Name: workplaces_workobject_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user_name
--

SELECT pg_catalog.setval('public.workplaces_workobject_id_seq', 10, true);
...
--
-- Name: workplaces_area workplaces_area_pkey; Type: CONSTRAINT; Schema: public; Owner: user_name
--

ALTER TABLE ONLY public.workplaces_area
    ADD CONSTRAINT workplaces_area_pkey PRIMARY KEY (id);


--
-- Name: workplaces_workobject workplaces_workobject_pkey; Type: CONSTRAINT; Schema: public; Owner: user_name
--

ALTER TABLE ONLY public.workplaces_workobject
    ADD CONSTRAINT workplaces_workobject_pkey PRIMARY KEY (id);
...
--
-- Name: workplaces_area_location_id_d07e71e5; Type: INDEX; Schema: public; Owner: user_name
--

CREATE INDEX workplaces_area_location_id_d07e71e5 ON public.workplaces_area USING btree (location_id);


--
-- Name: workplaces_workobject_supervisor_id_f6e1e3a0; Type: INDEX; Schema: public; Owner: user_name
--

CREATE INDEX workplaces_workobject_supervisor_id_f6e1e3a0 ON public.workplaces_workobject USING btree (supervisor_id);
...
--
-- Name: authtoken_token authtoken_token_user_id_35299eff_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: user_name
--
...
--
-- Name: workplaces_area workplaces_area_location_id_d07e71e5_fk_workplace; Type: FK CONSTRAINT; Schema: public; Owner: user_name
--

ALTER TABLE ONLY public.workplaces_area
    ADD CONSTRAINT workplaces_area_location_id_d07e71e5_fk_workplace FOREIGN KEY (location_id) REFERENCES public.workplaces_workobject(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: workplaces_workobject workplaces_workobject_supervisor_id_f6e1e3a0_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: user_name
--

ALTER TABLE ONLY public.workplaces_workobject
    ADD CONSTRAINT workplaces_workobject_supervisor_id_f6e1e3a0_fk_auth_user_id FOREIGN KEY (supervisor_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;
